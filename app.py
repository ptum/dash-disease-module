...
def filter_data(selection):
    ...
    return df_subset.iloc[:,[7,4,2,5,3,1]].rename(columns={'mid':'Module ID','module_size':'Module Size','pval':'Pvalue','gwas_name':'GWAS name','net':'Network','traitGroup':'Phenotype category'}).head()
